...
export const money = <i className="fa-solid fa-indian-rupee-sign"></i>; // Updated to Indian rupee icon
...
export const users = <i className="fa-solid fa-users"></i>; // Updated to more generic user icon
export const indian = <i className="fa-solid fa-indian-rupee-sign"></i>;
...
export const book = <i className="fa-solid fa-book"></i>; // Updated to more generic book icon
